...
public class Product
{
    ...
    // Полный путь к картинке — удобно отдавать в JSON для модалки
    public string ImageUrl => "/img/" + Image;
}

// Отзыв о товаре (для AJAX-эндпоинта GetProductReviews)
public class Review
{
